...
public class VideoStoreTest
{
	...
	public void test_rental_newRelease_movie_using_3_loyalty_point(){
		...
		customer.createAndAddRental(newReleaseMovie, 2, 3);
	...
	public void test_rental_newRelease_movie_using_2_loyalty_point(){
		...
		customer.createAndAddRental(newReleaseMovie, 1, 3);
	...
	public void testSingleNewReleaseStatement(){
		customer.createAndAddRental( new Movie("The Cell", MovieType.NEW_RELEASE), 3, 0);
	...
	public void testDualNewReleaseStatement(){
		customer.createAndAddRental( new Movie("The Cell", MovieType.NEW_RELEASE), 3, 0);
		customer.createAndAddRental( new Movie("The Tigger Movie", MovieType.NEW_RELEASE), 3, 0);
		String expected = String.format("Rental Record for Fred\n\tThe Cell\t%.1f\n\tThe Tigger Movie\t%.1f\nYou owed %.1f\nYou earned 4 frequent renter points\n", 9.0, 9.0, 18.0);
		Assertions.assertEquals(expected, customer.statement());
	}
	@Test
	public void testSingleChildrensStatement(){
		customer.createAndAddRental( new Movie ("The Tigger Movie", MovieType.CHILDREN), 3, 0);
		String expected = String.format("Rental Record for Fred\n\tThe Tigger Movie\t%.1f\nYou owed %.1f\nYou earned 1 frequent renter points\n", 1.5, 1.5);
		Assertions.assertEquals(expected, customer.statement());
	}
	@Test
	public void testMultipleRegularStatement(){
		customer.createAndAddRental( new Movie("Plan 9 from Outer Space", MovieType.REGULAR), 1, 0);
		customer.createAndAddRental( new Movie("8 1/2", MovieType.REGULAR), 2, 0);
		customer.createAndAddRental( new Movie("Eraserhead", MovieType.REGULAR), 3, 0);
	...
	public void testStatement(){
		customer.createAndAddRental( new Movie("Plan 9 from Outer Space", MovieType.REGULAR), 1, 0);
		customer.createAndAddRental( new Movie("8 1/2", MovieType.REGULAR), 2, 0);
		customer.createAndAddRental( new Movie("The Cell", MovieType.NEW_RELEASE), 4, 2);
		customer.createAndAddRental( new Movie("Eraserhead", MovieType.REGULAR), 3, 4);
